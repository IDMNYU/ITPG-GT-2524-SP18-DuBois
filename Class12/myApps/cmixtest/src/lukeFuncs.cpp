...
void RTcmixInit()
{
    ...
    // the "line" maketable works with time, value pairs
    // the "wave" maketable works with harmonic amplitudes
    string thescore = "srand() \
    amp0 = maketable(\"line\", 1000, 0., 0., 0.01, 1., 2., 0.1, 10, 0) \
    wave0 = maketable(\"wave\", 1000, 1.) \
    amp1 = maketable(\"line\", 1000, 0., 0., 1., 1., 1.1, 0.) \
    wave1 = maketable(\"line\", 1000, 0., -1., 1., 1.) \
    amp2 = maketable(\"line\", 1000, 0., 0., 1., 1., 2., 0.) \
    wave2 = maketable(\"wave\", 1000, 0.5, 0, 0.6, 0., 0.3, 0., 0.1, 0) \
